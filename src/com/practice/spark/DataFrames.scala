...
/*Playing arround with Data Frames in Scala; Used functionality like Select, GroupBy, Count*/
...
object DataFrames {
  ...
  def main(args: Array[String]) {
    ...
    val lines = spark.sparkContext.textFile("D:/Study/SparkScala/SparkScala/fakefriends.csv")
