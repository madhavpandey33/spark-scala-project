...
object MostPopularSuperhero {
  ...
  def main(args: Array[String]) {
    ...
    val leastPopularName =  namesRdd.lookup(leastPopular._2)(0)
    
    // Print out our answer!
    println(s"$mostPopularName is the most popular superhero with ${mostPopular._1} co-appearances.") 
    
    println(s"$leastPopularName is the most popular superhero with ${leastPopular._1} co-appearances.")
  }
